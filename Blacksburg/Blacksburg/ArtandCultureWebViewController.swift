//
//  ArtandCultureWebViewController.swift
//  Blacksburg
//
...
class ArtandCultureWebViewController: UIViewController {

    // websiteURL and countryName are set by the upstream view controller
    
    var linkName: String = "Art and Culture"
    ...
    override func viewDidLoad() {
        ...
        */
        var url = NSURL(string: "http://blacksburg.va.us/Index.aspx?page=246")
        /*
