//
//  LatestNewsWebViewController.swift
//  Blacksburg
//
...
class LatestNewsWebViewController: UIViewController {

    // websiteURL and countryName are set by the upstream view controller
    
    var linkName: String = "Latest News"
    ...
    override func viewDidLoad() {
        ...
        */
        var url = NSURL(string: "http://blacksburg.va.us/Index.aspx?page=304")
        /*
