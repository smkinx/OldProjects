...
class PlacesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        var btFilePath: NSString? = NSBundle.mainBundle().pathForResource("places", ofType: "plist")
        ...
        if let dictionaryForPlistFile = dictionaryFromFile {
            ...
            */
            ...
            showErrorMessageFor("places.plist")
            return
        }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject!) {
        ...
        if segue.identifier == "web" {
            ...
            var webViewController: PlacesWebViewController = segue.destinationViewController as PlacesWebViewController
